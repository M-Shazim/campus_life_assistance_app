...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? AppHomePageWidget() : LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'addAssignment',
          path: '/addAssignment',
          builder: (context, params) => AddAssignmentWidget(),
        ),
        FFRoute(
          name: 'editAssignment',
          path: '/editAssignment',
          builder: (context, params) => EditAssignmentWidget(
            titleREF: params.getParam(
              'titleREF',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'addFeedback',
          path: '/addFeedback',
          builder: (context, params) => AddFeedbackWidget(
            uidREF: params.getParam(
              'uidREF',
              ParamType.String,
            ),
