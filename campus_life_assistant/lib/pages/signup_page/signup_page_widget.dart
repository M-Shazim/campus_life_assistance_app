...
class _SignupPageWidgetState extends State<SignupPageWidget> {
  ...
  void initState() {
    ...
    _model.signuusernameTextController ??= TextEditingController();
    _model.signuusernameFocusNode ??= FocusNode();

    _model.signuppasswordTextController ??= TextEditingController();
    _model.signuppasswordFocusNode ??= FocusNode();

    _model.cfnsignuppasswordTextController ??= TextEditingController();
    _model.cfnsignuppasswordFocusNode ??= FocusNode();
  }
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.signuusernameTextController,
                                focusNode: _model.signuusernameFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Username',
                                ...
                                keyboardType: TextInputType.emailAddress,
                                validator: _model
                                    .signuusernameTextControllerValidator
                                    .asValidator(context),
                              ),
                              TextFormField(
                              ...
                              TextFormField(
                                controller:
                                    _model.cfnsignuppasswordTextController,
                                focusNode: _model.cfnsignuppasswordFocusNode,
                                autofocus: false,
                                obscureText:
                                    !_model.cfnsignuppasswordVisibility,
                                decoration: InputDecoration(
                                  ...
                                  await UserRecord.collection
                                      ...
                                      .update(createUserRecordData(
                                        ...
                                        password: _model
                                            .signuppasswordTextController.text,
                                        displayName: _model
                                            .signuusernameTextController.text,
                                      ));
