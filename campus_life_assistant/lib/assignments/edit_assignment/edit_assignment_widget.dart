...
import 'edit_assignment_model.dart';
export 'edit_assignment_model.dart';
...
class _EditAssignmentWidgetState extends State<EditAssignmentWidget> {
  ...
  void initState() {
    ...
    _model.updateSubjectFocusNode ??= FocusNode();
                  ...
                  child: StreamBuilder<List<AssignmentsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<AssignmentsRecord>
                          scrollingColumnAssignmentsRecordList = snapshot.data!;
                      final scrollingColumnAssignmentsRecord =
                          scrollingColumnAssignmentsRecordList.isNotEmpty
                              ? scrollingColumnAssignmentsRecordList.first
                              : null;
                                    ...
                                    children: [
                                      TextFormField(
                                        controller:
                                          ...
                                          text: scrollingColumnAssignmentsRecord
                                              ?.title,
                                        ),
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .updateTitleTextControllerValidator
                                            .asValidator(context),
                                      ),
                                      TextFormField(
                                        controller: _model
                                                .updateSubjectTextController ??=
                                            TextEditingController(
                                          text: scrollingColumnAssignmentsRecord
                                              ?.subject,
                                        ),
                                        focusNode:
                                            _model.updateSubjectFocusNode,
                                        autofocus: true,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        obscureText: false,
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .updateSubjectTextControllerValidator
                                            .asValidator(context),
                                      ),
                                      TextFormField(
                                        controller: _model
                                        ...
                                        focusNode:
                                            _model.updateDescriptionFocusNode,
                                        autofocus: true,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        obscureText: false,
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await scrollingColumnAssignmentsRecord!
                                        .reference
                                        .update(createAssignmentsRecordData(
                                      title:
                                          _model.updateTitleTextController.text,
                                      description: _model
                                          .updateDescriptionTextController.text,
                                      duedate: _model.datePicked,
                                      subject: _model
                                          .updateSubjectTextController.text,
                                    ));
