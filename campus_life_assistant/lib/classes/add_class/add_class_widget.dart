...
class _AddClassWidgetState extends State<AddClassWidget> {
  ...
  void initState() {
    ...
    _model.addSubjectTextController ??= TextEditingController();
    _model.addSubjectFocusNode ??= FocusNode();

    _model.addRoomTextController ??= TextEditingController();
    _model.addRoomFocusNode ??= FocusNode();

    _model.addDayTextController ??= TextEditingController();
